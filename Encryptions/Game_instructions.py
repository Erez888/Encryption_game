...
def menu(on_begin=None):
    ...
    tk.Frame(menu, bg=ACCENT, height=4).place(x=0, y=0, relwidth=1)
    instructions_title = tk.Label(menu, text="Game Instructions:",
    ...
    instructions_label = tk.Label(menu, text=instructions_text,
                                  font=("Georgia", 12), bg=BG, fg=SUBTEXT, justify="left", wraplength=600)
    ...
    begin_button = tk.Button(menu, text="Click to Begin!",
                             font=FONT_BTN, bg=ACCENT, fg=TEXT,
                             activebackground=ACCENT, activeforeground=TEXT,
                             relief="flat", bd=0, cursor="hand2", width=20, height=4, command=on_press)
